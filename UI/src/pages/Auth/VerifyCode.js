...
const VerifyCode = ({email}) => {
  ...
  return (
    <div className='p-4'>
      ...
      <input type='text' name='otp' value={values?.otp} maxLength={6} onChange={handleOnChange} placeholder='6 digit code' className='h-[48px] border rounded border-gray-600 p-2 mt-4' required/>
